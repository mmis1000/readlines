(function() {
  var BufferList, CHAR_N, CHAR_R, EventEmitter, callsite, fs, path, readlines,
  ...
  readlines = (function(_super) {
    ...
    readlines.prototype.parseData_ = function(Eof) {
      var current, i, lineUpdate;
      i = 0;
      lineUpdate = false;
      while (void 0 !== (current = this.buffers.get(i++))) {
        switch (current) {
          case CHAR_N:
      ...
      return this.buffers = new BufferList;
    };
    ...
    readlines.prototype.readline = function() {
      var line;
      if (this.lines.length < this.options.lines * this.options.preloadLinesRatio) {
